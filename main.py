...
mbti_data = {
    ...
    "INTJ": {
        ...
        "colors": [{"name": "옵시디언 블랙 (자켓/원피스)", "hex": "#111827"}, {"name": "일렉트릭 퍼플 (이너/가방 포인트)", "hex": "#7C3AED"}, {"name": "다크 실버 (메탈릭 무드)", "hex": "#9CA3AF"}]
    },
    "ISTP": {
        ...
        "colors": [{"name": "카키 브라운 (자켓/팬츠)", "hex": "#4B5563"}, {"name": "엠버 골드 (스니커즈 포인트)", "hex": "#F59E0B"}, {"name": "딥 딥 올리브 (베이스 컬러)", "hex": "#78350F"}]
    },
    "ISFP": {
        ...
        "colors": [{"name": "미스티 라벤더 (가디건)", "hex": "#DDD6FE"}, {"name": "살몬 피치 (블러셔 추천)", "hex": "#FCA5A5"}, {"name": "크림 옐로우 (스커트/셔츠)", "hex": "#FEF08A"}]
    },
    "INFP": {
        "title": "빈티지 오키드 포레스트", "group": "🍁 가을 웜톤 / 🌸 여름 쿨 (Mute 믹스)",
        "desc": "몽환적이고 빈티지한 느낌을 주는 뮤트 톤의 조화가 독보적인 아우라를 만들어 냅니다.",
        "tips": ["에스닉/빈티지 레이어드 룩", "말린 장미(MLBB) 컬러링", "앤틱 원석 반지"], "traits": ["몽환적인", "빈티지", "유니크"],
        "colors": [{"name": "오키드 포그 (원피스/니트)", "hex": "#C084FC"}, {"name": "올드 포레스트 (아우터)", "hex": "#15803D"}, {"name": "더스티 로즈 (립/치크 컬러)", "hex": "#FB7185"}]
    },
    "INTP": {
        "title": "디지털 테크 사이언", "group": "❄️ 겨울 쿨톤 (Winter Bright)",
        "desc": "차가우면서도 눈에 띄는 네온 사이언과 인디고 블루가 지적이면서도 트렌디한 무드를 풍깁니다.",
        "careers": ["소프트웨어 아키텍트", "연구원", "데이터 분석가"], 
        "tips": ["스트리트웨어 / 스포티 룩", "세미매트 피부 표현", "스마트 워치/실버 프레임"], "traits": ["테크니컬", "미래지향", "시원한"],
        "colors": [{"name": "네온 사이언 (포인트 셔츠)", "hex": "#06B6D4"}, {"name": "인디고 헤더 (데님/슬랙스)", "hex": "#4338CA"}, {"name": "바이올렛 일루전 (액세서리)", "hex": "#6D28D9"}]
    },
    "ESTP": {
        "title": "스포티 파이어 레드", "group": "🌱 봄 워터/브라이트 (Spring Bright)",
        "desc": "시선을 사로잡는 강렬한 원색과 채도 높은 컬러가 활력 넘치고 섹시한 이미지를 극대화해 줍니다.",
        "tips": ["에슬레저 룩 / 화려한 프린팅", "글로시하고 선명한 오렌지 레드립", "골드 체인"], "traits": ["에너제틱", "과감한", "비비드"],
        "colors": [{"name": "파이어 비비드 레드 (자켓)", "hex": "#DC2626"}, {"name": "네온 오렌지 (스포츠 웨어)", "hex": "#EA580C"}, {"name": "선샤인 크롬 골드 (액세서리)", "hex": "#FBBF24"}]
    },
    "ESFP": {
        "title": "팝핑 비비드 마젠타", "group": "🌱 봄 워터/브라이트 (Spring Bright)",
        "desc": "인간 비타민 그 자체! 톡톡 튀는 팝 컬러와 화려한 글리터가 화사한 이목구비를 더욱 살려줍니다.",
        "tips": ["화려한 패턴 플레어 원피스", "트윙클 펄 글리터 메이크업", "유니크한 비즈 주얼리"], "traits": ["화려한", "톡톡튀는", "사교적인"],
        "colors": [{"name": "팝핑 핫 핑크 (미니백/상의)", "hex": "#EC4899"}, {"name": "네온 만다린 (치크/립)", "hex": "#FF7849"}, {"name": "브라이트 카나리아 (원피스)", "hex": "#FFC82C"}]
    },
    "ENFP": {
        ...
        "colors": [{"name": "스윗 코랄 (매일 쓰는 베스트 립)", "hex": "#F43F5E"}, {"name": "네온 라임 (티셔츠/스니커즈)", "hex": "#84CC16"}, {"name": "소프트 파스텔 골드 (소품)", "hex": "#FCD34D"}]
    },
    "ENTP": {
        ...
        "colors": [{"name": "일렉트릭 마젠타 (포인트 아우터)", "hex": "#D946EF"}, {"name": "사이버 사이언 (유니크 셔츠)", "hex": "#0891B2"}, {"name": "볼드 토마토 레드 (볼캡/가방)", "hex": "#EF4444"}]
    },
    "ESTJ": {
        ...
        "colors": [{"name": "로얄 네이비 (수트 셋업)", "hex": "#1D4ED8"}, {"name": "딥 브릭 레드 (타이/넥레이스)", "hex": "#B91C1C"}, {"name": "다크 세라믹 그레이 (슬랙스)", "hex": "#374151"}]
    },
    "ESFJ": {
        ...
        "colors": [{"name": "스윗 허니 오렌지 (블라우스)", "hex": "#FB923C"}, {"name": "브라이트 골든 꿀 (스커트)", "hex": "#FBBF24"}, {"name": "소프트 웜 민트 (포인트 가디건)", "hex": "#2DD4BF"}]
    },
    "ENFJ": {
        ...
        "colors": [{"name": "선샤인 골드 (원피스/재킷)", "hex": "#EAB308"}, {"name": "딥 트로피컬 핑크 (립 추천)", "hex": "#DB2777"}, {"name": "트루 아쿠아 (스카프/가방)", "hex": "#06B6D4"}]
    },
    "ENTJ": {
        ...
        "colors": [{"name": "크림슨 버건디 (롱코트)", "hex": "#991B1B"}, {"name": "리치 딥 네이비 (이너 타이/셔츠)", "hex": "#1E3A8A"}, {"name": "제트 블랙 (가죽 아우터)", "hex": "#1F2937"}]
    }
}
...
with st.sidebar:
    ...
    st.write("---")
    st.caption("내 성향과 분위기(MBTI) 데이터를 기반으로 시각적 안정감을 주는 베스트 컬러셋을 제안하는 뷰티/패션 가이드 앱입니다.")
...
if menu == "🏠 가이드 소개":
    ...
    st.success("💡 **스타일링 팁:** 본 매칭 컬러칩을 쇼핑(옷, 화장품, 스마트폰 케이스 등) 시 가이드로 활용해 보세요. 내 이미지와 핏이 딱 맞는 놀라운 안정감을 경험할 수 있습니다.")
...
# -----------------------------------------------------
    ...
    st.markdown("<div class='sub-title'>MBTI 조합이 가진 분위기별 최적의 퍼스널 컬러를 진단합니다.</div>", unsafe_allow_html=True)
...
# -----------------------------------------------------
    ...
    with g_col1:
        ...
        <div style='background-color: #FFFBEB; padding: 20px; border-radius: 10px; margin-bottom:15px; border: 1px solid #FDE68A;'>
            ...
            <p><b>스타일링 키워드:</b> 코랄, 피치, 라이트 골드, 생기발랄함, 글리터, 다정하고 영(Young)한 무드</p>
        </div>
    ...
    with g_col2:
        ...
        <div style='background-color: #F5F3FF; padding: 20px; border-radius: 10px; margin-bottom:15px; border: 1px solid #DDD6FE;'>
            ...
            <p><b>스타일링 키워드:</b> 올블랙, 비비드 마젠타, 일렉트릭 블루, 볼드 실버, 강한 대비감, 시크하고 도회적인 카리스마</p>
        </div>
        """, unsafe_allow_html=True)
